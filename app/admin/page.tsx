...
export default function AdminPage() {
  ...
  return <AdminShell>
    ...
    <section className="admin-panel admin-quick"><LocalizedElement as="h2">Quick actions</LocalizedElement><LocalizedElement as="p">Manage homepage images and brand logos, then update your catalog and editorial content.</LocalizedElement>
      <LocalizedElement as="div"><LocalizedElement as="a" href="/admin/hero-slides">Manage hero slides</LocalizedElement><LocalizedElement as="a" href="/admin/brands">Update brand logos</LocalizedElement><LocalizedElement as="a" href="/admin/homepage">Arrange homepage sections</LocalizedElement><LocalizedElement as="a" href="/admin/settings">Website settings &amp; logo</LocalizedElement><LocalizedElement as="a" href="/admin/seo">Page SEO</LocalizedElement><LocalizedElement as="a" href="/admin/videos">Manage videos</LocalizedElement><LocalizedElement as="a" href="/admin/tractors">Add a tractor</LocalizedElement><LocalizedElement as="a" href="/admin/articles">Create an article</LocalizedElement><LocalizedElement as="a" href="/admin/leads">Review enquiries</LocalizedElement></LocalizedElement>
    </section>
  </AdminShell>;
}

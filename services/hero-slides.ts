...
export type HeroSlide = { id: string; title?: string; image?: string; order?: number; backgroundColor?: string; status?: string; heading?: string; description?: string; imageAlt?: string; imageFit?: string; imagePosition?: string; duration?: number; ctaLabel?: string; ctaUrl?: string; secondaryCtaLabel?: string; secondaryCtaUrl?: string; updatedAt?: unknown };
